...
import com.emitrom.gwt4.ti.mobile.client.stream.IOStream;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * TCP socket that implements the 'titanium.iostream' interface. created by
 * com.emitrom.gwt4.ti.mobile.client.network.socket.Socket
 */
public class TCP extends IOStream {
    ...
    public native void setConnected(ConnectedCallback callback) /*-{
		...
		jso.connected = function(e) {
			var obj = @com.emitrom.gwt4.ti.mobile.client.network.socket.ConnectedCallbackArgs::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			callback.@com.emitrom.gwt4.ti.mobile.client.network.socket.ConnectedCallback::onConnect(Lcom/emitrom/gwt4/ti/mobile/client/network/socket/ConnectedCallbackArgs;)(obj);
		};
    }-*/;
    ...
    public native void setError(ErrorCallback callback) /*-{
		...
		jso.error = function(e) {
			var obj = @com.emitrom.gwt4.ti.mobile.client.network.socket.ErrorCallbackArgs::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e)
			callback.@com.emitrom.gwt4.ti.mobile.client.network.socket.ErrorCallback::onError(Lcom/emitrom/gwt4/ti/mobile/client/network/socket/ErrorCallbackArgs;)(obj);
		};
    }-*/;
    ...
    public native void setAccepted(AcceptedCallback callback) /*-{
		...
		jso.accepted = function(e) {
			var obj = @com.emitrom.gwt4.ti.mobile.client.network.socket.AcceptedCallbackArgs::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			callback.@com.emitrom.gwt4.ti.mobile.client.network.socket.AcceptedCallback::onAccepted(Lcom/emitrom/gwt4/ti/mobile/client/network/socket/AcceptedCallbackArgs;)(obj);
		};
    }-*/;
    ...
    public native void accept(AcceptParams params) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.accept(params.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
