...
import com.emitrom.gwt4.ti.mobile.client.cloud.core.Query;
...
public class Checkins extends TiModule {
    ...
    public native void create(Checkin request, CloudCheckinsResponseHandler handler)/*-{
		...
		peer
				.create(
						request.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.checkins.CloudCheckinsResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.checkins.CloudCheckinsResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/checkins/CloudCheckinsResponse;)(response);
						});
    }-*/;
    ...
    public native void query(Query query, CloudCheckinsResponseHandler handler)/*-{
		...
		peer
				.query(
						query.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.chats.CloudChatsResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.chats.CloudChatsResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/chats/CloudChatsResponse;)(response);
						});
    }-*/;
