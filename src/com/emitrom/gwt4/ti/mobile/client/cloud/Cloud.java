/**************************************************************************
   Cloud.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.cloud;

import com.emitrom.gwt4.ti.mobile.client.core.TiFactory;
import com.emitrom.gwt4.ti.mobile.client.core.TiModule;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.cloud.CloudStreamHandler;
...
public class Cloud extends TiModule {
    ...
    public native void setOnDataStream(CloudStreamHandler handler)/*-{
		...
		peer.ondatastream = function(e) {
			var obj = @com.emitrom.gwt4.ti.mobile.client.core.events.cloud.CloudStreamProgressEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
			handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.cloud.CloudStreamHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/cloud/CloudStreamProgressEvent;)(obj);
		};
    }-*/;
