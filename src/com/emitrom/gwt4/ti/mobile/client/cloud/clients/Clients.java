/**************************************************************************
   Clients.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.cloud.clients;
...
public class Clients extends TiModule {
    ...
    public native void geolocate(Client client, CloudClientsResponseHandler handler)/*-{
		...
		peer
				.geolocate(
						client.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.clients.CloudClientsResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.clients.CloudClientsResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/clients/CloudClientsResponse;)(response);
						});
    }-*/;
