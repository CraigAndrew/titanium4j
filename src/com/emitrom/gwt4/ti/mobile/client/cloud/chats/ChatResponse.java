...
public class ChatResponse extends AbstractCloudResponse {
    ...
    public native User getFrom()/*-{
		...
		var user = peer.from;
		return @com.emitrom.gwt4.ti.mobile.client.cloud.core.User::new(Lcom/google/gwt/core/client/JavaScriptObject;)(user);
    }-*/;

    public native ChatGroup getChatGroup()/*-{
		var peer = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var group = peer.chat_group;
		return @com.emitrom.gwt4.ti.mobile.client.cloud.chats.ChatGroup::new(Lcom/google/gwt/core/client/JavaScriptObject;)(group);
    }-*/;
