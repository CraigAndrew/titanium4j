...
public class Chats extends TiModule {
    ...
    public native void create(ChatMessage message, CloudChatsResponseHandler handler)/*-{
		...
		peer
				.create(
						message.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
    ...
    public native void getChatGroups(CloudChatGroupResponseHandler handler)/*-{
		...
		peer
				.getChatGroups(function(e) {
					var response = @com.emitrom.gwt4.ti.mobile.client.cloud.chats.CloudChatsGroupResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
					handler.@com.emitrom.gwt4.ti.mobile.client.cloud.chats.CloudChatGroupResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/chats/CloudChatsGroupResponse;)(eventObject);
				});
    }-*/;
