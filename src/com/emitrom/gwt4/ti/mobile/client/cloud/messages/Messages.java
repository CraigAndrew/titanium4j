 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.cloud.messages;
...
public class Messages extends TiModule {
    ...
    public native void create(Message message, MessageResponseHandler handler)/*-{
		...
		peer
				.create(
						...
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.messages.MessageResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.messages.MessageResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/messages/MessageResponse;)(response);
						});
    }-*/;
    ...
    public native void showInBox(SearchConfig config, MessageResponseHandler handler)/*-{
		...
		peer
				.showInBox(
						config.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.messages.MessageResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.messages.MessageResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/messages/MessageResponse;)(response);
						});
