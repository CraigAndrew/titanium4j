 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.cloud.acls;
...
public class Acls extends TiModule {
    ...
    public native void addUser(AclsEntity entry, AclsResponseHandler handler)/*-{
		...
		peer
				.addUser(
						entry.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var response = @com.emitrom.gwt4.ti.mobile.client.cloud.acls.AclsResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.cloud.acls.AclsResponseHandler::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/cloud/acls/AclsResponse;)(response);
						});
    }-*/;
