 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.media.ios;

import com.emitrom.gwt4.ti.mobile.client.core.events.EventDispatcher;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.PlayingChangeHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.StateChangeHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.VolumeChangeHandler;
import com.emitrom.gwt4.ti.mobile.client.media.Item;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * * The music player instance returned from
 * {@link com.emitrom.gwt4.ti.mobile.client.media.Media.createMusicPlayer} this
...
public class MusicPlayer extends EventDispatcher {
    ...
    public native void setNowPlaying(Item value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.nowPlaying = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void addPlayingChangeHandler(PlayingChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.PlayEvent::PLAYING_CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.PlayEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.PlayingChangeHandler::onPlayingChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/PlayEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addStateChangeHandler(StateChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.PlayEvent::STATE_CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.PlayEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.StateChangeHandler::onStateChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/PlayEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addVolumeChangeHandler(VolumeChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.VolumentEvent::VOLUME_CHANGE,
						function(e) {
							...
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.VolumeChangeHandler::onVolumeChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/VolumentEvent;)(eventObject);
						});
    }-*/;
