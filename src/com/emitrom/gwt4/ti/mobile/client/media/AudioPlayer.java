/**************************************************************************
   AudioPlayer.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.ProgressHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.AudioChangeHandler;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * The audioplayer object is returned by
 * {@link com.emitrom.gwt4.ti.mobile.client.media.Media.createAudioPlayer} and
...
public class AudioPlayer extends EventDispatcher {
    ...
    public native void addChangeHandler(AudioChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.ChangeEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.ChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.AudioChangeHandler::onChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/audio/ChangeEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addProgressHandler(ProgressHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.ProgressEvent::PROGRESS,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.ProgressEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.ProgressHandler::onProgess(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/ProgressEvent;)(eventObject);
						});
    }-*/;
