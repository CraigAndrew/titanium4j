/**************************************************************************
   VideoPlayer.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.video.VideoCompleteHandler;
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.media.Media.createVideoPlayer} and
...
public class VideoPlayer extends EventDispatcher {
    ...
    public native void setMedia(File value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.media = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void setNaturalSize(Size value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.naturalSize = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void setBackgroundView(HasWidgets view) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.setBackgroundView(view.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addCompleteHandler(VideoCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.video.VideoEvent::COMPLETE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.video.VideoEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.video.VideoCompleteHandler::onComplete(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/video/VideoEvent;)(eventObject);
						});
    }-*/;
