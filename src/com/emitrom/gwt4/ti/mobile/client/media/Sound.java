/**************************************************************************
   Sound.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ErrorHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.SoundCompleteHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.SoundResumeHandler;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * The sound object is returned by
 * {@link com.emitrom.gwt4.ti.mobile.client.media.Media.createSound} and is
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.media.Media.createAudioplayer} API.
 * <p>
...
public class Sound extends EventDispatcher {
    ...
    public native void addCompleteHandler(SoundCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.SoundCompleteEvent::COMPLETE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.SoundCompleteEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.SoundCompleteHandler::onSoundComplete(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/audio/SoundCompleteEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addErrorHandler(ErrorHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ErrorHandler::onError(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ErrorEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addResumeHandler(SoundResumeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.SoundResumeEvent::RESUME,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.media.audio.SoundResumeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.media.audio.SoundResumeHandler::onSoundResume(Lcom/emitrom/gwt4/ti/mobile/client/core/events/media/audio/SoundResumeEvent;)(eventObject);
						});
    }-*/;
