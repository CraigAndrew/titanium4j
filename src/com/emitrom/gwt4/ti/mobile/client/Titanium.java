 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client;
...
import com.emitrom.gwt4.ti.mobile.client.ui.AlertDialog;
...
public class Titanium {
    ...
    public static native void fireEvent(String name, TiEvent eventObject) /*-{
		Titanium
				.fireEvent(
						name,
						eventObject.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
