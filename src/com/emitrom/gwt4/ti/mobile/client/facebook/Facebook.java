 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.facebook;

import com.emitrom.gwt4.ti.mobile.client.core.TiFactory;
import com.emitrom.gwt4.ti.mobile.client.core.TiModule;
import com.emitrom.gwt4.ti.mobile.client.core.events.LoginEvent;
import com.emitrom.gwt4.ti.mobile.client.core.events.LogoutEvent;
...
public class Facebook extends TiModule {
    ...
    public native LoginButton createLoginButton() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.facebook.LoginButton::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void request(String method, JavaScriptObject data, RequestCallback callback) /*-{
		...
		jso
				.request(
						...
						data,
						function(e) {
							var object = @com.emitrom.gwt4.ti.mobile.client.facebook.RequestArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.gwt4.ti.mobile.client.facebook.RequestCallback::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/facebook/RequestArguments;)(object);
						});
    }-*/;
    ...
    public static native void requestWithGraphPath(String path, JavaScriptObject params, String httpMethod,
		...
		jso
				.requestWithGraphPath(
						...
						httpMethod,
						function(e) {
							var object = @com.emitrom.gwt4.ti.mobile.client.facebook.GraphPathRequestArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.gwt4.ti.mobile.client.facebook.GraphPathRequestCallback::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/facebook/GraphPathRequestArguments;)(object);
						});
    }-*/;
    ...
    public static native void dialog(String action, JavaScriptObject params, DialogCallback callback) /*-{
		...
		jso
				.dialog(
						...
						params,
						function(e) {
							var object = @com.emitrom.gwt4.ti.mobile.client.facebook.DialogArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.gwt4.ti.mobile.client.facebook.DialogCallback::onResponse(Lcom/emitrom/gwt4/ti/mobile/client/facebook/DialogArguments;)(object);
						});
    }-*/;
