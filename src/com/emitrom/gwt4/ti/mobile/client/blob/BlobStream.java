/**************************************************************************
   BlobStream.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
public class BlobStream extends Blob {
    ...
    public native double write(Buffer buffer) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.write(buffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native double write(Buffer buffer, double offset, double length) /*-{
		...
		return jso
				.write(
						buffe.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						offset, length);
    }-*/;
