...
import com.emitrom.gwt4.ti.mobile.client.geolocation.Coordinates;
import com.emitrom.gwt4.ti.mobile.client.geolocation.android.LocationProvider;
...
public class LocationEvent extends TiEvent {
    ...
    public final native LocationProvider getProvider() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.geolocation.android.LocationProvider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public final native Coordinates getCoords() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()()
		var obj = jso.coords;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.geolocation.Coordinates::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
