/**************************************************************************
   TableViewEvent.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
package com.emitrom.gwt4.ti.mobile.client.core.events.ui.tableview;
...
import com.emitrom.gwt4.ti.mobile.client.ui.TableViewSection;
...
public class TableViewEvent extends UIEvent {
    ...
    public native TableViewSection getSection() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.section;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.TableViewSection::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native TableViewBaseModel getRowData() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.rowData;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.data.TableViewBaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native TableViewRow getRow() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.row;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.TableViewRow::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
