 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.core.events.ui.dashboard;

import java.util.ArrayList;

import com.emitrom.gwt4.ti.mobile.client.core.events.ui.UIEvent;
import com.emitrom.gwt4.ti.mobile.client.ui.DashboardItem;
...
public class DashboardEvent extends UIEvent {
	...
	/**
	 * The com.emitrom.gwt4.ti.mobile.client.ui.DashboardItem that was moved
	 */
	public final native DashboardItem getItem() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.item;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.DashboardItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
	}-*/;
