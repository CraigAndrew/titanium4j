...
public class TiEvent extends ProxyObject {
    ...
    public native ProxyObject getSource() /*-{
		...
		var obj = jso.source;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::create(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void setEventData(EventData data) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var attribute = @com.emitrom.gwt4.ti.mobile.client.core.events.EventData::DATA_ATTRIBUTE;
		jso[attribute] = data.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native EventData getEventData() /*-{
		...
		return @com.emitrom.gwt4.ti.mobile.client.core.events.EventData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(toReturn);
    }-*/;
