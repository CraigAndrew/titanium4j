/**************************************************************************
   JSON.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.core.json;
    ...
    public static native <T extends JavaScriptObject> T parse(String text, Reviver reviver)/*-{
		return JSON
				.parse(
						text,
						function(key, value) {
							return reviver.@com.emitrom.gwt4.ti.mobile.client.core.json.Reviver::evaluate(Ljava/lang/String;Ljava/lang/String;)(key, value);
						});
    }-*/;
