/**************************************************************************
   TiEventListener.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class TiEventListener<T extends TiEvent> {
    ...
    private static native JavaScriptObject createPeer(TiEventListener<?> listener) /*-{
		var callback = function(e) {
			...
			listener.@com.emitrom.gwt4.ti.mobile.client.core.events.TiEventListener::fireOnEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/TiEvent;)(eventObject);
		};
