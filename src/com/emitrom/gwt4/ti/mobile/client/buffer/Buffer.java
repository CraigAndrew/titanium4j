/**************************************************************************
   Buffer.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.buffer;
...
public class Buffer extends EventDispatcher {
    ...
    public native double append(Buffer sourceBuffer) /*-{
		...
		return jso
				.append(sourceBuffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native double append(Buffer sourceBuffer, int sourceOffset) /*-{
		...
		return jso
				.append(
						sourceBuffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						sourceOffset);
    }-*/;
     ...
     *         {@link com.emitrom.gwt4.ti.mobile.codec.CHARTSET_UTF8} is the
     *         default.
     */
