...
public class Map extends TiModule {
    ...
    public native Annotation createAnnotation() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.map.Annotation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    ...
    public static native MapView createView() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.createAnnotation();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.map.MapView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
