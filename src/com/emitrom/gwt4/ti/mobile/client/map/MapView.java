/**************************************************************************
   MapView.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.map;

import java.util.ArrayList;

import com.emitrom.gwt4.ti.mobile.client.core.handlers.geolocation.GeoErrorHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.geolocation.RegionChangeHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.loading.LoadCompleteHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.loading.LoadHandler;
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.map.Map.createmapview} and is used
...
public class MapView extends View {
    ...
    public native Region getRegion() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.region;
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.map.Region::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;

    public native void setRegion(Region value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.region = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void addAnnotation(Annotation annotation) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.addAnnotation(annotation.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void deselectAnnotation(Annotation annotation) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.deselectAnnotation(annotation.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void removeAnnotation(Annotation annotation) /*-{
		jso
				.removeAnnotation(annotation.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void selectAnnotation(Annotation annotation) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.selectAnnotation(annotation.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addLoadCompleteHandler(LoadCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.loading.LoadEvent::COMPLETE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.loading.LoadEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.loading.LoadCompleteHandler::onLoadComplete(Lcom/emitrom/gwt4/ti/mobile/client/core/events/loading/LoadEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addErrorHandler(GeoErrorHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ErrorEvent::ERROR,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.geolocation.GeoErrorEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.geolocation.GeoErrorHandler::onError(Lcom/emitrom/gwt4/ti/mobile/client/core/events/geolocation/GeoErrorEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addLoadingHandler(LoadHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.loading.LoadEvent::LOADING,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.loading.LoadEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.loading.LoadHandler::onLoad(Lcom/emitrom/gwt4/ti/mobile/client/core/events/loading/LoadEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addRegionChangedHandler(RegionChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.RegionEvent::REGION_CHANGED,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.RegionEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.geolocation.RegionChangeHandler::onRegionChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/RegionEvent;)(eventObject);
						});
    }-*/;
