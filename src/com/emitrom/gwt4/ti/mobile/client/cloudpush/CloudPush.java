...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.cloudpush.CloudPushAppHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.cloudpush.CloudPushCallbackHandler;
...
public class CloudPush extends TiModule {
    ...
    public native void retrieveDeviceToken(CloudPushNotificationConfig config)/*-{
		var peer = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		peer
				.retrieveDeviceToken(config.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addCallbackHandler(CloudPushCallbackHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.cloudpush.CloudPush::CALLBACK,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.cloudpush.CloudPushCallbackEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.cloudpush.CloudPushCallbackHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/cloudpush/CloudPushCallbackEvent;)(eventObject);
						});
    }-*/;
    ...
    private native void addAppHandler(String event, CloudPushAppHandler handler)/*-{
		...
		jso
				.addEventListener(
						event,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.cloudpush.CloudPushEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.cloudpush.CloudPushAppHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/cloudpush/CloudPushEvent;)(eventObject);
						});
    }-*/;
