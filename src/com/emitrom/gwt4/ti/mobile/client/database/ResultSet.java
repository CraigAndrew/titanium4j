...
public class ResultSet extends EventDispatcher {
     ...
     * @param index column index (which is zero based)
     * @param type One of (
     *            {@link com.emitrom.gwt4.ti.mobile.client.database.Database.FIELD_TYPE_STRING}
     *            {@link com.emitrom.gwt4.ti.mobile.client.database.Database.FIELD_TYPE_INT}
     *            {@link com.emitrom.gwt4.ti.mobile.client.database.Database.FIELD_TYPE_FLOAT}
     *            {@link com.emitrom.gwt4.ti.mobile.client.database.Database.FIELD_TYPE_DOUBLE}
     *            )
     */
