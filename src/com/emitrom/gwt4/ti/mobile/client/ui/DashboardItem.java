 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.DashboardView}. the dashboard
 * item is created by the method
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.createDashboardItem}
 * 
...
public class DashboardItem extends EventDispatcher implements HasImage {
    ...
    public native void addClickHandler(DashboardItemHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.dashboard.DashboardEvent::CLICK,
						function(e) {
