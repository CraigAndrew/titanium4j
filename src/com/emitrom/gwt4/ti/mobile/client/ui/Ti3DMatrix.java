/**************************************************************************
   Ti3DMatrix.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 * constructor.
 * 
 * User Matrix3D instead
 * 
 * @deprecated
 */
public class Ti3DMatrix extends EventDispatcher {

    public Ti3DMatrix() {
        createPeer();
    }

    Ti3DMatrix(JavaScriptObject obj) {
        jsObj = obj;
    }
    ...
    public native Ti3DMatrix invert() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.invert();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.Ti3DMatrix::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
     ...
     * @param y The y part of the vector about which to rotate
    ...
    private void createPeer() {
        jsObj = UI.create3DMatrix();
    }

    public static Ti3DMatrix from(ProxyObject obj) {
        return new Ti3DMatrix(obj.getJsObj());
    }
