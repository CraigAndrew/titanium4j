...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TabGroupHandler;
...
public class TabGroup extends View {
    ...
    public native Tab getActiveTab() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.Tab::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void addTab(Tab tab) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.addTab(tab.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void open(Animation animation) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.open(animation.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addBlurHandler(TabGroupHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.tab.TabEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TabGroupHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/tab/TabEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addCloseHandler(TabGroupHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.UIEvent::CLOSE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.tab.TabEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TabGroupHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/tab/TabEvent;)(eventObject);
						});
    ...
    public native void addFocusHandler(TabGroupHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.tab.TabEvent::FOCUS,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.tab.TabEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TabGroupHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/tab/TabEvent;)(eventObject);
						});
    ...
    public native void addOpenHandler(TabGroupHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.UIEvent::OPEN,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.tab.TabEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TabGroupHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/tab/TabEvent;)(eventObject);
						});
