 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.createTextField}. the
 * TextField is a single line field.
 * <p>
 * On iPhone, the borderStyle can be set with a constant from
 * com.emitrom.gwt4.ti.mobile.client.ui.UI.
 * 
...
public class TextField extends View {
     ...
     *         ,
     *         {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.TEXT_AUTOCAPITALIZATION_SENTENCES}
     *         , or
     *         {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.TEXT_AUTOCAPITALIZATION_ALL}
    ...
    public native void setLeftButton(Button value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.leftButton = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void setRightButton(Button value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.rightButton = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void setTextAlign(String value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.textAlign = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void addBlurHandler(TextHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::BLUR,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TextHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/text/TextEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addChangeHandler(TextHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TextHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/text/TextEvent;)(eventObject);
						});
    ...
    public native void addFocusHandler(TextHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::FOCUS,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TextHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/text/TextEvent;)(eventObject);
						});
    ...
    public native void addReturnHandler(TextHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::RETURN,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.text.TextEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.TextHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/text/TextEvent;)(eventObject);
						});
