/**************************************************************************
   Ti2DMatrix.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
/**
 * The Ti2DMatrix is created by
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.create2DMatrix} . The 2d
 ...
 * @deprecated
 */
public class Ti2DMatrix extends EventDispatcher {

    public Ti2DMatrix() {
        createPeer();
    }

    Ti2DMatrix(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     */
    public native Ti2DMatrix invert() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.invert();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.Ti2DMatrix::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
     ...
     */
    public native Ti2DMatrix multiply(Ti2DMatrix t2) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.multiply(t2.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.Ti2DMatrix::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
     ...
     */
    public native Ti2DMatrix rotate(double angle) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
     ...
     */
    public native Ti2DMatrix scale(double sx, double sy) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
     ...
     */
    public native Ti2DMatrix translate(double tx, double ty) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    ...
    public static Ti2DMatrix from(ProxyObject obj) {
        return new Ti2DMatrix(obj.getJsObj());
    }
