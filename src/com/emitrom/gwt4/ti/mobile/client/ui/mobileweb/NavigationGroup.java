...
package com.emitrom.gwt4.ti.mobile.client.ui.mobileweb;
...
public class NavigationGroup extends View {
    ...
    public native void close(Window window)/*-{
		...
		jso
				.close(window.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void open(Window window)/*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.open(window.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Window getWindow()/*-{
		...
		return @com.emitrom.gwt4.ti.mobile.client.ui.Window::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
