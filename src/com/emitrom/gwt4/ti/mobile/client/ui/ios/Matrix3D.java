/**************************************************************************
   Matrix3D.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
public class Matrix3D extends EventDispatcher {
    ...
    public native Matrix3D invert() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.invert();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.ui.ios.Matrix3D::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
