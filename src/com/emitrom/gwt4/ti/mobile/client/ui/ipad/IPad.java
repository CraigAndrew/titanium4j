...
public class IPad extends TiModule {
    ...
    static native JavaScriptObject createSplitWindow(View detail, View master) /*-{
		var detailView = detail.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var masterView = master.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
