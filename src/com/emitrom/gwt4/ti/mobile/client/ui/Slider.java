 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.createSlider}.
 */
public class Slider extends View implements HasExtremum {
    ...
    public native void addChangeHandler(SliderChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.slider.SliderEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.slider.SliderEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.SliderChangeHandler::onChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/slider/SliderEvent;)(eventObject);
						});
    }-*/;
