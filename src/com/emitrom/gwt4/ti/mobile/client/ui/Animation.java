...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.AnimationCompleteHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.AnimationStartHandler;
...
public class Animation extends EventDispatcher {
    ...
    public native void addCompleteHandler(AnimationCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.CompleteEvent::COMPLETE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.CompleteEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.AnimationCompleteHandler::onComplete(Lcom/emitrom/gwt4/ti/mobile/client/core/events/CompleteEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addStartHandler(AnimationStartHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.UIEvent::START,
						function(e) {
							...
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.AnimationStartHandler::onStart(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/UIEvent;)(eventObject);
						});
    }-*/;
