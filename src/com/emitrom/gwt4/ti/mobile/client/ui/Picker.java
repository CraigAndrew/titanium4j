/**************************************************************************
   Picker.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.PickerChangeHandler;
 ...
 * com.emitrom.gwt4.ti.mobile.client.ui.UI.createPicker. A picker can be used to
...
public class Picker extends View {
     ...
     *         {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.PICKER_TYPE_TIME}
    ...
    public native void add(PickerRow row) /*-{
		jso
				.add(row.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void add(PickerColumn column) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.add(column.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void reloadColumn(PickerColumn column) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.reloadColumn(column.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addChangeHandler(PickerChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.picker.PickerChangeEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.picker.PickerChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.PickerChangeHandler::onChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/picker/PickerChangeEvent;)(eventObject);
						});
    }-*/;
