...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.ChangeHandler;
import com.emitrom.gwt4.ti.mobile.client.ui.View;

/**
 * The adview is a view for display apple iads. the view is created by the
 * method {@link com.emitrom.gwt4.ti.mobile.client.ui.ios.IOS.createAdView}.
 */
public class AdView extends View {
		...
		jso
				.addEventListener(
						...
						function(e) {
							...
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.ChangeHandler::onChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/UIEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addLoadHandler(LoadHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.loading.LoadEvent::LOAD,
						function(e) {
