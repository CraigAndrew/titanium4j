...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.CoverFlowIndexChangeHandler;
...
public class CoverFlowView extends View {
    ...
    public native void setImage(int index, Blob image) /*-{
		...
		jso
				.setImage(
						index,
						image.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addChangeHandler(CoverFlowIndexChangeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.ChangeEvent::CHANGE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.ChangeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.CoverFlowIndexChangeHandler::onChange(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/ChangeEvent;)(eventObject);
						});
