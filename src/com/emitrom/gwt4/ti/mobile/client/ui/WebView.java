...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.WebViewHandler;
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.ui.UI.createWebView}.
 * <p>
...
public class WebView extends View {
    ...
    public native void setData(Blob value) /*-{
		...
		jso.data = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
    ...
    public native void addBeforeLoadHandler(WebViewHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::BEFORE_LOAD,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.WebViewHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/webview/WebViewEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addErrorHandler(WebViewHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::ERROR,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.WebViewHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/webview/WebViewEvent;)(eventObject);
						});
    ...
    public native void addLoadHandler(WebViewHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::LOAD,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.ui.webview.WebViewEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.ui.WebViewHandler::onEvent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/ui/webview/WebViewEvent;)(eventObject);
						});
