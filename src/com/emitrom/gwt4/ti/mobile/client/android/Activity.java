...
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.CreateHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.DestroyHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.PauseHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.ResumeHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.StartHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.StopHandler;
import com.emitrom.gwt4.ti.mobile.client.core.handlers.intent.NewIntentHandler;
...
public class Activity extends EventDispatcher {
    ...
    public native Intent getIntent() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.Intent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void setResult(int resultCode, Intent intent) /*-{
		...
		jso
				.setResult(
						resultCode,
						intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void startActivity(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.startActivity(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void addCreateHandler(CreateHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::CREATE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.CreateEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.CreateHandler::onCreate(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addDestroyHandler(DestroyHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::DESTROY,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.DestroyEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.DestroyHandler::onDestroy(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addNewIntentHandler(NewIntentHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.android.NewIntentEvent::NEW_INTENT,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.android.NewIntentEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.intent.NewIntentHandler::onNewIntent(Lcom/emitrom/gwt4/ti/mobile/client/core/events/android/NewIntentEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addPauseHandler(PauseHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::PAUSE,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.PauseEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.PauseHandler::onPause(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addResumeHandler(ResumeHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::RESUME,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.ResumeHandler::onResume(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addStartHandler(StartHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::START,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.StartHandler::onStart(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addStopHandler(StopHandler handler)/*-{
		...
		jso
				.addEventListener(
						@com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::STOP,
						function(e) {
							var eventObject = @com.emitrom.gwt4.ti.mobile.client.core.events.activity.ActivityEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.gwt4.ti.mobile.client.core.handlers.activity.StopHandler::onStop(Lcom/emitrom/gwt4/ti/mobile/client/core/events/activity/ActivityEvent;)(eventObject);
						});
    }-*/;
