...
public class Android extends TiModule {
    ...
    public native RemoteViews createRemoteViews(Object config) /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.RemoteViews::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native Notification createNotification(Object options) /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.Notification::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native PendingIntent createPendingIntent(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.createPendingIntent(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.PendingIntent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native Service createService(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.createService(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.Service::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native boolean isServiceRunning(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.isServiceRunning(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void startService(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.startService(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void stopService(Intent intent) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.stopService(intent.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native Activity getCurrentActivity() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.Activity::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
