...
public class Menu extends EventDispatcher {
    ...
    public native MenuItem add(MenuItemConfig config) /*-{
		...
		return this
				.add(config.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native MenuItem add(String itemTitle, int id) /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(menuItem);
		return toReturn;
    }-*/;
    ...
    public native MenuItem findItem(int item) /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.android.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
