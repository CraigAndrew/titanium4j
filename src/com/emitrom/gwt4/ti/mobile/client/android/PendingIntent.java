/**************************************************************************
   PendingIntent.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
public class PendingIntent extends EventDispatcher {
    ...
    public PendingIntent(JavaScriptObject obj) {
        jsObj = obj;
    }
    ...
    public final native void setIntent(Intent value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso.intent = value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
    }-*/;
