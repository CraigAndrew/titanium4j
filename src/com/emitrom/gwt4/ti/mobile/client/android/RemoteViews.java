/**************************************************************************
   RemoteViews.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 * com.emitrom.gwt4.ti.mobile.client.Notification)
 */
public class RemoteViews extends EventDispatcher {
    ...
    public RemoteViews(JavaScriptObject obj) {
        jsObj = obj;
    }
     ...
     * 
     * @param viewId , The resource id of the View (also see
     ...
     * @param methodName , The name of the method to call
     * 
     * @param base , The time at which the timer would have read 0:00
     * @param format , The Chronometer format string, or null to simply display
     *            the timer value
     ...
     * 
     * @param viewId , The resource id of the ImageView whose image should
     *            change (also see Titanium.App.Android.R)
     ...
     * @param viewId , The resource id of the ImageView whose image should
     *            change (also see Titanium.App.Android.R)
     * @param uri , The URI of the image (both AndroidMedia and Titanium URLs
     *            are supported)
     */
     ...
     * @param viewId , The resource id of the View (also see
     *            Titanium.App.Android.R)
     * @param max , The new max value of the ProgressBar
     * @param progress , The new progress value of the ProgressBar (from 0..max)
     ...
     * @param viewId , The resource id of the View (also see
     *            Titanium.App.Android.R)
     * @param visibility , The visibility, one of AndroidMedia.VISIBLE,
