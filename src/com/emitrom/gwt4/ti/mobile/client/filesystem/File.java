/**************************************************************************
   File.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.filesystem;
...
public class File extends EventDispatcher {
    ...
    public native boolean append(Blob contents) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.append(contents.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native FileStream open(int mode) /*-{
		...
		return @com.emitrom.gwt4.ti.mobile.client.filesystem.FileStream::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native File getParent() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.parent;
		return @com.emitrom.gwt4.ti.mobile.client.filesystem.File::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native Blob read() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.read();
		return @com.emitrom.gwt4.ti.mobile.client.blob.Blob::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native boolean write(Blob contents) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.write(contents.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
     ...
     *            {@link com.emitrom.gwt4.ti.mobile.client.filesystem.File} to
     *            file
     * @param append
    ...
    public native boolean write(Blob contents, boolean append) /*-{
		...
		return jso
				.write(
						contents.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						append);
    }-*/;
