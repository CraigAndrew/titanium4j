...
public class FileSystem extends TiModule {
    ...
    public static native File createFile() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.filesystem.File::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native FileStream createFileStream() /*-{
		...
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.filesystem.FileStream::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;

    /**
     * Create temp file and return a
     * {@link com.emitrom.gwt4.ti.mobile.client.filesystem.File}
     */
     ...
     * {@link com.emitrom.gwt4.ti.mobile.client.filesystem.File} object
     * 
     * @param path
