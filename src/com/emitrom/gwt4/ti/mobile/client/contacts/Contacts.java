...
public class Contacts extends TiModule {
     ...
     * com.emitrom.gwt4.ti.mobile.client.contacts.Group. Only on iOs available
     * 
     */
    public native Group createGroup() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.createGroup();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.contacts.Group::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
     ...
     *            com.emitrom.gwt4.ti.mobile.client.contacts.Group.Group
     */
    ...
    /**
     * Create and return an instance of
     * com.emitrom.gwt4.ti.mobile.client.contacts.Person. Only available on iOs.
     */
    public native Person createPerson() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.createPerson();
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.contacts.Person::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
     ...
     * 
     * @param parameters (optional) a dictionary object properties defined in
     *            com.emitrom.gwt4.ti.mobile.client.contacts.Person
     */
    ...
    /**
     * Returns an of all
     * {@link com.emitrom.gwt4.ti.mobile.client.contacts.Group} objects in the
     ...
     * {@link com.emitrom.gwt4.ti.mobile.client.contacts.Person} objects in the
     * contacts database
     */
    ...
    /**
     * Returns a {@link com.emitrom.gwt4.ti.mobile.client.contacts.Group} object
    ...
    /**
     * Returns an array of
     * {@link com.emitrom.gwt4.ti.mobile.client.contacts.Person} objects who
    ...
    /**
     * Returns a {@com.emitrom.gwt4.ti.mobile.client.contacts.Person} object
     * with the given id
     * 
     ...
     * @param group The {@link com.emitrom.gwt4.ti.mobile.client.contacts.Group}
     *            object to remove from the database.
     */
    public native void removeGroup(Group group) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.removeGroup(group.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
     ...
     * 
     * @param person The
     *            {@link com.emitrom.gwt4.ti.mobile.client.contacts.Person}
     *            object to remove from the database.
     */
    public native void removePerson(Person person) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		return jso
				.removePerson(person.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
