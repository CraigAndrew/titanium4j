/**************************************************************************
   Element.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.xml.Node} defined by a start-tag and
 * end-tag (or an empty tag). elements may have
 * attributes(com.emitrom.gwt4.ti.mobile.client.xml.Attr) associated with them.
...
public class Element extends Node {
     ...
     * @return The {@link com.emitrom.gwt4.ti.mobile.client.xml.Attr} value as a
     ...
     * 
     * @param name The name of the attribute
     * @return The {@link com.emitrom.gwt4.ti.mobile.client.xml.Attr} value, or
    ...
    public native Attr setAttributeNode(Attr newAttr) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.setAttributeNode(newAttr.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.xml.Attr::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native void removeAttributeNode(Attr oldAttr) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.removeAttributeNode(oldAttr.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;

    /**
     * Retrieves a {@link com.emitrom.gwt4.ti.mobile.client.xml.NodeList} of all
    ...
    /**
     * Retrieves an attribute value by local name and namespace uri, returning
     * it as a {@link com.emitrom.gwt4.ti.mobile.client.xml.Attr} object.
     * 
     * @param namespaceURI The namespace URI of the attribute to retrieve.
     * @param localName The local name of the attribute to retrieve.
    ...
    public native Attr setAttributeNodeNS(Attr newAttr) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.setAttributeNodeNS(newAttr.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.xml.Attr::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
