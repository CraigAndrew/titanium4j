/**************************************************************************
   NamedNodeMap.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
 ...
 * {@link com.emitrom.gwt4.ti.mobile.client.xml.Node} objects. this conforms to
...
public class NamedNodeMap extends EventDispatcher {
    ...
    public native Node setNamedItem(Node node) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.setNamedItem(node.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.xml.Node::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
    ...
    public native Node setNamedItemNS(Node node) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso
				.setNamedItemNS(node.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
		var toReturn = @com.emitrom.gwt4.ti.mobile.client.xml.Node::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
