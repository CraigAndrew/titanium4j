/**************************************************************************
   Stream.java is part of Titanium4j Mobile 3.0.  Copyright 2012 Emitrom LLC
...
public class Stream extends TiModule {
	...
	public native IOStream createStream(StreamConfig config) /*-{
		...
		var configObjet = config.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
	...
	public native void read(IOStream sourceStream, Buffer buffer,
		...
		jso
				.read(
						sourceStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						buffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var args = @com.emitrom.gwt4.ti.mobile.client.stream.ReadArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							readCallback.@com.emitrom.gwt4.ti.mobile.client.stream.ReadCallback::onRead(Lcom/emitrom/gwt4/ti/mobile/client/stream/ReadArguments;)(args);
						});
	}-*/;
	...
	public static native void readAll(IOStream sourceStream) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.readAll(sourceStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
	}-*/;
	...
	public native void write(IOStream outputStream, Buffer buffer,
		...
		jso
				.write(
						outputStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						buffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var args = @com.emitrom.gwt4.ti.mobile.client.stream.WriteArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							readCallback.@com.emitrom.gwt4.ti.mobile.client.stream.ReadCallback::onRead(Lcom/emitrom/gwt4/ti/mobile/client/stream/ReadArguments;)(args);
						});
	}-*/;
	...
	public native void writeStream(IOStream inputStream, IOStream outputStream,
		...
		jso
				.writeStream(
						inputStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						outputStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						maxChunkSize);
	}-*/;
	...
	public native void pump(IOStream inputStream, PumpCallback callback,
		...
		jso
				.pump(
						inputStream.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()(),
						function(e) {
							var args = @com.emitrom.gwt4.ti.mobile.client.stream.PumpArguments::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							callback.@com.emitrom.gwt4.ti.mobile.client.stream.PumpCallback::onPump(Lcom/emitrom/gwt4/ti/mobile/client/stream/PumpArguments;)(args);
						}, maxChunkSize);
	}-*/;
