...
import com.emitrom.gwt4.ti.mobile.client.codec.Codec;
import com.emitrom.gwt4.ti.mobile.client.codec.DecodeNumberSpec;
import com.emitrom.gwt4.ti.mobile.client.codec.DecodeStringSpec;
import com.emitrom.gwt4.ti.mobile.client.codec.EncodeNumberSpec;
...
public class IOStream extends EventDispatcher {
	...
	public native double read(Buffer buffer) /*-{
		...
		return jso
				.read(buffer.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
	}-*/;
	...
	private Number readNumber(String type) throws IOException {
		...
		encodeSpec.setByteOrder(Codec.BIG_ENDIAN);
		...
		if (bytesRead < length) {
			throw new IOException("Read " + bytesRead + " bytes instead of "
					+ length);
		}
		...
		decodeNumberSpec.setByteOrder(Codec.BIG_ENDIAN);
	...
	public int readInt() throws IOException {
		Number number = readNumber(Codec.TYPE_INT);
	...
	public long readLong() throws IOException {
		Number number = readNumber(Codec.TYPE_LONG);
	...
	public byte readByte() throws IOException {
		Number number = readNumber(Codec.TYPE_BYTE);
	...
	public short readShort() throws IOException {
		Number number = readNumber(Codec.TYPE_SHORT);
	...
	public float readFloat() throws IOException {
		Number number = readNumber(Codec.TYPE_FLOAT);
	...
	public double readDouble() throws IOException {
		Number number = readNumber(Codec.TYPE_DOUBLE);
	...
	public String readUtf8String() throws IOException {
		...
		decodeSpec.setCharset(Codec.CHARSET_UTF8);
	...
	private void writeNumber(String type, Number number) throws IOException {
		...
		if (bytesWritten < length) {
			throw new IOException("Wrote " + bytesWritten
	...
	public void writeByte(int value) throws IOException {
		writeNumber(Codec.TYPE_BYTE, value);
	}
	...
	public void writeInt(int value) throws IOException {
		writeNumber(Codec.TYPE_INT, value);
	}
	...
	public void writeShort(short value) throws IOException {
		writeNumber(Codec.TYPE_SHORT, value);
	}
	...
	public void writeLong(long value) throws IOException {
		writeNumber(Codec.TYPE_LONG, value);
	}
	...
	public void writeFloat(float value) throws IOException {
		writeNumber(Codec.TYPE_FLOAT, value);
	}
	...
	public void writeDouble(double value) throws IOException {
		writeNumber(Codec.TYPE_DOUBLE, value);
	}
