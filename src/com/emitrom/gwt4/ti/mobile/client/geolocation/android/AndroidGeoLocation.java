 ...
 **************************************************************************/
package com.emitrom.gwt4.ti.mobile.client.geolocation.android;
 ...
 * com.emitrom.gwt4.ti.mobile.client.geolocation.Geolocation.
 */
public class AndroidGeoLocation extends TiModule {
    ...
    public native void addLocationRule(LocationRule value) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.addLocationRule(value.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native LocationProvider createLocationProvider() /*-{
		...
		return @com.emitrom.gwt4.ti.mobile.client.geolocation.android.LocationProvider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void removeLocationProvider(LocationProvider locationProvider) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.removeLocationProvider(locationProvider.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native void removeLocationRule(LocationRule locationRule) /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		jso
				.removeLocationRule(locationRule.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()());
    }-*/;
    ...
    public native LocationRule createLocationRule() /*-{
		var jso = this.@com.emitrom.gwt4.ti.mobile.client.core.ProxyObject::getJsObj()();
		var obj = jso.createLocationProvider();
		return @com.emitrom.gwt4.ti.mobile.client.geolocation.android.LocationRule::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
