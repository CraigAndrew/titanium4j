/************************************************************************
  WindowBound.java is part of Titanium4j Desktop 1.2  Copyright 2012 Emitrom LLC
...
public class WindowBound extends JavaScriptObject {

	protected WindowBound() {

	}

	public static native WindowBound create()/*-{
		return {};
	}-*/;
