...
import com.emitrom.ti4j.desktop.client.app.properties.Properties;
...
public class App extends JavaScriptObject {
  ...
  /**
   * Convert the given app URL to a filesystem path. App URLs generally have the
   * form 'app://subdir/resource.html' and resolve to a fileystem path rooted in
  ...
  public static native Properties createProperties()/*-{
		return Ti.App.createProperties();
  }-*/;
  ...
  /**
   * Return the command-line arguments passed to this application, excluding the
   * first which is the path to the application executable.
   * 
   * @return
   */
   ...
   * contains the application Resources directory and bundled components. On OS
   * X this is the directory "My App.app/Contents" and on Windows and Linux it
   * is simply the path to the application.
   * 
   * @return
   */
  ...
  /**
   * Get this human readable id defined in both the application manifest and the
   * application's tiapp.xml file.
   * 
   * @return
   */
  ...
  /**
   * Return the full path to the application icon. The application icon path is
   * specified in the application manifest and tiapp.xml relative to the
   ...
   * 
   * @param arguments, Any number of String arguments which will be appended as
  ...
  public static native Properties getSystemProperties()/*-{
		return Ti.App.getSystemProperties();
  }-*/;
   ...
   * @return
   */
  public static native JsArray<Properties> loadProperties(String path)/*-{
   ...
   * 
   * @param value, The data to print.
   * @return
   */
  public static native String sdterr(Object value)/*-{
   ...
   * Reads from stdin
   * 
   * @param prompt, Text prompt for input. If not specified, no prompt will
   *          appear.
   * @return
   */
  public static native String sdtin(String prompt)/*-{
   ...
   * @param prompt, Text prompt for input. If not specified, no prompt will
   *          appear.
   * @param delimiter, Will continue reading stdin until the delimiter character
   *          is reached. If no argument is specified, this method will continue
